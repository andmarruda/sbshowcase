...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer(['template.public', 'homepage', 'product-detail', 'product-list', 'template.customer', 'template.includes.product', 'admin.dashboard', 'email.order-receive', 'email.order-advice'], PublicTemplateComposer::class);
