        ...
        <div class="d-flex justify-content-end align-items-center" style="margin-top:2rem;">
            <div style="text-align:center; margin-right:3rem;">
                <div class="input-group" style="width:auto;">
                    ...
                    <input type="number" class="textfield" step="1" min="0" max="{{$Product['product']->quantity}}" value="{{$Product['quantity']}}" style="text-align: center; width:80px;">
                    <button class="btn btn-outline-secondary" data-type="plus" type="button" id="button-addon2">+</button>
                </div>

                <a href="{{route('cart-remove', ['product_id' => $Product['product']->id])}}" class="btn btn-outline-danger btn-sm" style="margin-top:0.5rem;">Remover item</a>
            </div>
            <div>
