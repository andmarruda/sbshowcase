    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-between">
            <ul class="list-inline">
                ...
                <li class="list-inline-item"><a href="{{$sn->url}}" title="{{$sn->socialMedia()->first()->name}}" target="_blank"><img src="{{asset($sn->socialMedia()->first()->icon)}}" alt="{{$sn->socialMedia()->first()->name}}" width="20px" height="20px"></a></li>
                @endforeach
